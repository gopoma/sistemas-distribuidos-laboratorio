...
public class SOAPImplServiceLocator extends org.apache.axis.client.Service implements labSD.SOAPImplService {
    ...
    public labSD.SOAPI getSOAPImplPort() throws javax.xml.rpc.ServiceException {
    ...
    public labSD.SOAPI getSOAPImplPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            labSD.SOAPImplPortBindingStub _stub = new labSD.SOAPImplPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (labSD.SOAPI.class.isAssignableFrom(serviceEndpointInterface)) {
                labSD.SOAPImplPortBindingStub _stub = new labSD.SOAPImplPortBindingStub(new java.net.URL(SOAPImplPort_address), this);
                _stub.setPortName(getSOAPImplPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://labSD/", "SOAPImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://labSD/", "SOAPImplPort"));
        }
